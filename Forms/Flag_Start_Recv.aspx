<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Flag_Start_Recv.aspx.cs" Inherits="Flag_Start_Recv" %>
...
<div id="selectionPanel">
        ...
        <div id="selectonTable" runat="server" class="raPanel">
            ...
            <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="False" 
                ...
                OnClientClick="window.open('Flag_Lookup_Recv.aspx?PREVPAGE=Flag_Start_Recv.aspx','','resizable=no,scrollbars=yes,menubar=no,toolbar=no,location=no,width=500,height=600');" />
            <br />
            <br />
