<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Inspec_Priority.aspx.cs" Inherits="Inspec_Priority" %>
...
<div>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                ...
                onrowcreated="GridView1_RowCreated" onselectedindexchanged="GridView1_SelectedIndexChanged" OnSorting="GridView1_Sorting" 
                >
...
WHERE EMP_CURR_WC_ID = 71"></asp:SqlDataSource>
                    ...
                    <asp:TemplateField HeaderText="PTS&lt;br/&gt;Date 2" Visible="False">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="PTS&lt;br/&gt;Qty 2" Visible="False">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="PTS&lt;br/&gt;Date 3" Visible="False">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="PTS&lt;br/&gt;Qty 3" Visible="False">
                        <ItemTemplate>
                    ...
                    <asp:BoundField DataField="ITEM_REF1" HeaderText="Pkg&lt;br/&gt;Type" 
                    ...
                    <ItemStyle HorizontalAlign="Center" BackColor="#FFFF99" />
                    </asp:BoundField>
                    <asp:BoundField HeaderText="Insp/Pkg&lt;br/&gt;Qty" HtmlEncode="False" 
                        DataField="ALLOC" >
                    <ItemStyle HorizontalAlign="Center" BackColor="#FFFF99" />
                    </asp:BoundField>
                    <asp:BoundField DataField="PKG_TYPE" HeaderText="VM&lt;br/&gt;DF" 
...
ORDER BY ITEM_ITEMLIST.ITEM,DEMANDTYPE,REQD_DATE">
            ...
            <asp:Button  CssClass="raButton" ID="UpdateButton" runat="server" CausesValidation="True"
                Text="Save" onclick="UpdateButton_Click" Visible="False"></asp:Button>&nbsp; &nbsp;&nbsp;&nbsp;<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Button" />
        <br />
        </div>
