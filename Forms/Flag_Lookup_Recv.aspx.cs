...
public partial class Flag_Lookup_Recv : System.Web.UI.Page
{
    ...
    {
        this.GridView1.DataSource = new DAL().FlagLookupRecv(this.txtPartNbr.Text.Trim(),this.DropDownList1.SelectedValue );
